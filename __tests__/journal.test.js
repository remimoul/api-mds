...
test('SEND EMOTION - Emotion valide', async () => {
  let res;
  try {
...
describe('GET EMOTION - Emotion valide', () => {
  ...
  test('Doit retourner 201 pour une émotion valide', async () => {
...
describe('GET EMOTION - Utilisateur non trouvé', () => {
  ...
  test('Doit retourner 404 pour un utilisateur non trouvé', async () => {
    const res = await request(server).get('/journal/get/24332').set('Authorization', token);
